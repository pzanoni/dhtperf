...
// Profile.h includes PoissonRandom.h
#include "../Profile.h"

namespace dp = dhtperfproto;

template <>
void PoissonRandom<DhtPutEvent>::pushElement(dp::timeUnit time)
{
...
template <>
void PoissonRandom<DhtGetEvent>::pushElement(dp::timeUnit time)
{
    std::string key;
